                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4 mt-4">
                      <button 
                        ...
                        className="px-4 py-2 text-white bg-red-500 rounded-full shadow-lg hover:bg-red-600 transition duration-300"
                      >
                        Remove
                      </button>
                      ...
                      <button 
                        ...
                        className="px-4 py-2 text-white bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition duration-300"
                      >
                        Add
                      </button>
                    </div>
