...
export default function Header() {
  ...
  return (
    ...
    >
              ...
              <li>
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="absolute left-0 z-10 mt-2 w-48 bg-white rounded-md shadow-lg">
                      <ul className="py-1">
                        <li><NavLink to="/men" className="block px-4 py-2 text-gray-800 hover:bg-gradient-to-r from-purple-500 to-pink-400 hover:text-white" onClick={closeMobileMenu}>Men</NavLink></li>
                        <li><NavLink to="/women" className="block px-4 py-2 text-gray-800 hover:bg-gradient-to-r from-purple-500 to-pink-400 hover:text-white" onClick={closeMobileMenu}>Women</NavLink></li>
                        <li><NavLink to="/kids" className="block px-4 py-2 text-gray-800 hover:bg-gradient-to-r from-purple-500 to-pink-400 hover:text-white" onClick={closeMobileMenu}>Kids</NavLink></li>
                      </ul>
                    </div>
                  )}
                </div>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-gradient-to-r from-purple-500 to-pink-400 p-4" ref={mobileMenuRef}>
          <ul className="flex flex-col space-y-2">
            ...
            <li>
              ...
              {isMobileDropdownOpen && (
                <ul className="pl-4">
                  ...
                  <li><NavLink to="/women" className="block py-2 text-white hover:bg-gradient-to-r from-purple-500 to-pink-400" onClick={closeMobileMenu}>Women</NavLink></li>
                  <li><NavLink to="/kids" className="block py-2 text-white hover:bg-gradient-to-r from-purple-500 to-pink-400" onClick={closeMobileMenu}>Kids</NavLink></li>
                </ul>
              )}
            </li>
