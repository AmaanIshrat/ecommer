...
function Knowme() {
  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-black'} min-h-screen`}>
      <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-50'} py-12 px-4 sm:px-6 lg:px-8`}>
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-extrabold text-purple-600 text-center mb-6">
            Welcome to Our Shopping Paradise!
          </h1>
          <p className={`text-lg ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} text-center mb-8`}>
            Our shopping website is your one-stop destination for all things fashion! Whether you’re looking for
            men’s wear, women’s wear, or kids’ apparel, we’ve got you covered with the best deals and trends.
          </p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Men’s Collection */}
            <div className={`${theme === 'dark' ? 'bg-gray-700' : 'bg-white'} p-6 shadow-lg rounded-lg`}>
            ...
            <div className={`${theme === 'dark' ? 'bg-gray-700' : 'bg-white'} p-6 shadow-lg rounded-lg`}>
              ...
              <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-4`}>
                Explore our vibrant women’s collection, perfect for every occasion. From chic dresses to everyday
                wear, our range is designed to bring out the best in you!
              </p>
            ...
            <div className={`${theme === 'dark' ? 'bg-gray-700' : 'bg-white'} p-6 shadow-lg rounded-lg`}>
              ...
              <p className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-4`}>
                Our kids’ collection is playful and comfortable, designed to suit the little ones! Browse through fun
                outfits that your kids will love to wear every day.
              </p>
